<template>
  <div class="error-page-404">
    ...
    <div class="error">
      ...
      <div class="error__subtitle">This is an NotFound page</div>
      <!-- <div class="error__description">This is an NotFound page</div> -->
      <button class="error__button error__button--active" @click="$router.push({ name: 'root' })">
        Go to main page
      </button>
      <!-- <button class="error__button" @click="$router.push({ name: 'root' })">CONTACT</button> -->
    </div>
...
onMounted(() => {
  cordCanvas = document.getElementById('cord') as HTMLCanvasElement
