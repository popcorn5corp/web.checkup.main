export default {
  ...
  login: {
    ...
    signUpDesc: 'Sudah memiliki akun?',
    signUpComplete: 'Pendaftaran { name } telah selesai',
    privacyTerms: 'Saya menyetujui kebijakan & ketentuan privasi',
    serviceTerms: 'Saya setuju dengan syarat dan ketentuan layanan.',
    authPhone: 'Otentikasi dengan nomor ponsel',
    authEmail: 'Verifikasi melalui email',
    certifiSuccessText: 'ID ini dikonfirmasi dengan informasi otentikasi.',
